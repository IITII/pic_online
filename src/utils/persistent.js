...
const videoGet = (key, storage = localStorage) => getI(prefix.image + key, storage)
//set
...
const imageSet = (key, value, storage = localStorage) => setI(prefix.ui + key, value, storage)
const videoSet = (key, value, storage = localStorage) => setI(prefix.ui + key, value, storage)
//remove
...
const imageRemove = (key, storage = localStorage) => removeI(prefix.ui + key, storage)
const videoRemove = (key, storage = localStorage) => removeI(prefix.ui + key, storage)
